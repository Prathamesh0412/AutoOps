...
import type { Action } from "@/lib/unified-store"
...
export function ActionsPanel() {
  ...
  const { executeAction, rejectAction, rollbackAction } = useStoreActions()
  ...
  const handleApprove = async (id: string) => {
    ...
    // Toast notification will be shown by the real-time event listener
  }
  ...
  const handleHold = async (id: string) => {
    ...
    toast({
      title: "Action Held",
      description: "Action has been put on hold.",
    })
  }
  ...
  const saveMessage = (id: string) => {
    // In a real implementation, this would update the action message
