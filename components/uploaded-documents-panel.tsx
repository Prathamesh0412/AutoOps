          ...
          <div className="space-y-4">
            ...
            {uploadedFiles.map((file) => {
              ...
              return (
                <div
                  key={file.id}
                  className={`group flex items-start gap-4 rounded-lg border border-border bg-card p-4 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 hover:border-blue-800/30 hover:bg-blue-50/50 dark:hover:bg-blue-950/20 ${
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <div className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-primary/10 transition-colors group-hover:bg-blue-800/20">
