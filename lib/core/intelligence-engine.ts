...
export class IntelligenceEngine {
  ...
  static calculateChurnRisk(customer: Customer, recentOrders: Order[]): number {
    let risk = 0
  ...
  static calculateInventoryRisk(product: Product, recentOrders: Order[]): {
    risk: number
  ...
  static generateActions(insights: Insight[]): Action[] {
