...
import type { SentimentCategory, CustomerCategory } from './sentiment'
...
export async function generateEmailContent(input: EmailGenerationInput): Promise<EmailContent> {
...
function buildPrompt(input: EmailGenerationInput) {
...
function extractStructuredEmail(text?: string) {
  if (!text) return null
...
function buildRuleBasedEmail({ customerName, feedback, sentiment }: EmailGenerationInput): EmailContent {
